...
typedef struct PgFdwRelationInfo
{
	...
	/* Semijoin optimization fields */
	bool		semijoin_eligible;		/* can this be used as semijoin? */
	Var		   *semijoin_key;			/* the join key column (if eligible) */
	Var		   *semijoin_local_key;		/* matching key from the local rel */
	int			semijoin_threshold;		/* max keys for semijoin */
} PgFdwRelationInfo;
