...
static void postgresGetForeignPaths(PlannerInfo *root,
									RelOptInfo *baserel,
									Oid foreigntableid,Cost *startup_cost,Cost *total_cost);
						...
						Oid foreigntableid,Cost *startup_cost,Cost *total_cost)
{
	...
	foreach(lc, baserel->joininfo)
	{
		...
		if (!is_foreign_expr(root, baserel, rinfo->clause))
			{
				/* --- YOUR OPTIMIZATION START --- */

/* Estimate selectivity of join clause */
Selectivity sel;
...
/* If highly selective, prioritize pushdown */
if (sel < 0.1)
{
    /* reduce cost artificially to prefer this path */
    (*startup_cost) *= 0.5;
    (*total_cost) *= 0.5;
}

/* --- YOUR OPTIMIZATION END --- */
			}
						...
						Cost *p_startup_cost, Cost *p_total_cost)
{
	...
	/* --- YOUR NETWORK COST OPTIMIZATION --- */

/* Penalize large data transfer */
if (retrieved_rows > 50000)
{
    double penalty = retrieved_rows * 0.02;  // tune this factor
    total_cost += penalty;
}
